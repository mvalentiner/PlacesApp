//
//  TwitterAppUserAuthenticatedRequestTest.swift
//  PlacesUnitTests
//
...
class TwitterAppUserAuthenticatedRequestTest: XCTestCase {

	private class TwitterTestRequest: TwitterAppUserAuthenticatedRequest {
